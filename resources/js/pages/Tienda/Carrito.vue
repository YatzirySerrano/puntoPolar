...
<template>
  <PublicLayout>
    <section class="relative overflow-hidden">
      <img :src="heroImg" alt="Carrito" class="h-[190px] w-full object-cover md:h-[280px]" />
      <div class="absolute inset-0 bg-[linear-gradient(180deg,rgba(9,17,28,0.58)_0%,rgba(9,17,28,0.72)_100%)]" />
